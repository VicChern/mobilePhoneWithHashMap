 ...
 * Not decided problems:
 * In this case usersInput normally working with next() method only
 * In next contacts, your phone number should contains
 * at most the same number of digits that contains first contact
 * or would be thrown Mismatch Exception.
 * What about the size of com.company.MobilePhone.MobilePhone class? Should I separate it to more class.
 * Or size is OK?
 */
...
public class MobilePhone {
    ...
    private void addNewContact() throws InputMismatchException {
        try {
    ...
    public final void menu() {
        ...
        int point = 0;
        try {
            point = usersInput.nextInt();
        } catch (Exception e) {
            System.out.println("Only numbers accepted, please repeat");
        }
        switch (point) {
            case 1:
                listOfContacts();
